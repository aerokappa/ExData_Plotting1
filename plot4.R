...
with(reqData,plot(datetime,reqData[,3],type="l",xlab="",ylab="Global Active Power"))

with(reqData,plot(datetime,reqData[,5],type="l",xlab="datetime",ylab="Voltage"))
...
legend("topright",col=c("black","red","blue"),bty="n",text.font=0.5,legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=1)

with(reqData,plot(datetime,reqData[,4],type="l",xlab="datetime",ylab="Global_reactive_power"))
